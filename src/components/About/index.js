...
const About = () => {
  return (
    <Flex flexDir="row" w="100%" mt="30rem" h="auto" alignSelf="center">
      <Flex flexDir="column" width="100%">
        ...
        <Flex flexDir="row" justifyContent="space-between" w={["100%", "50%"]}>
